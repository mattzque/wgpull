...
mod tests {
    ...
    use wgpull_shared::{request::NodePullRequest, time::CurrentTime};
    ...
    fn test_context_remove_expired_nodes() {
        ...
        assert!(state1.nodes.contains_key("node1"));
        assert!(!state1.nodes.contains_key("node2"));
        assert!(state1.nodes.contains_key("node3"));
        ...
        assert_eq!(state2.nodes.len(), 3);
        assert!(state2.nodes.contains_key("node1"));
        assert!(state2.nodes.contains_key("node2"));
        assert!(state2.nodes.contains_key("node3"));
    }
}
